...
from boe.route import boe_router
from backend.lib.api.boe.sumario import download_boe_sumario


@boe_router.get("/sumario/{fecha}")
...
@boe_router.get("/sumario/range/{start_date}/{end_date}")
